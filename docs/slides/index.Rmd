...
---
# Ted Laderas, PhD (he/him)

.pull-left[
- Director of Training & Community
  - [Data Science Lab](https://ocdo.fredhutch.org/dasl), Fred Hutch Cancer Center
...
- Your Name, Pronouns and Affiliation
- What you hope to learn in today's workshop
- Favorite activity in February
...
.pull-left[
.tiny[
```{r aes_one, eval=FALSE, include=FALSE}
...
decorate("server3") %>% 
  flair(".data[[input$color_select]]", background = "#cdecff")

```

- connect our .bg-light-yellow[`selectInput`] to our `ggplot`
- use .bg-lightest-blue[`.data[[input$color_select]]`] as argument to `color` in `aes()`
]
...
- Documentation no longer supported by plotly; is user maintained
- Support may be sunsetted
- Alternatives: `{ggiraph}`, 

---
# Making a ggplot into a plotly plot

```{r plotly2, eval=FALSE, include=FALSE, warning=FALSE}
my_plot <- ggplot(biopics) +
  aes(x =box_office, 
      y=year_release,
      color=subject) +
...
- Quarto Dashboards - https://quarto.org/docs/dashboards/
    - Requires a slightly different set up for your apps:
- `bsLib` - https://rstudio.github.io/bslib/
    - New way to layout Shiny apps
...
- [Posit Connect Cloud](https://docs.posit.co/connect-cloud/how-to/r/shiny-r.html) - lets you publish apps
- https://shinyapps.io lets you host Shiny apps externally
- Can host your own Shiny Server internally
...
Shiny apps that run in your browser!
...
- Bluesky: https://bsky.app/profile/tladeras.bsky.social
- Ready4R Newsletter: https://buttondown.com/ready4r
